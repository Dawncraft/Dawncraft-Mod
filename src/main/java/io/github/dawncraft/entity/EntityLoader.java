...
public class EntityLoader
{
    ...
    public static void initEntities()
    {
        ...
        registerEntity(EntityBarbarianKing.class, "BarbarianKing", 64, 3, true);
        ...
        registerEntity(EntityThrowableTorch.class, "ThrowableTorch", 64, 10, true);
        registerEntity(EntityMFFireBall.class, "MagicFieldFireBall", 64, 10, true);
