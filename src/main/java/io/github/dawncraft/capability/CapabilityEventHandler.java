...
public class CapabilityEventHandler
{
    ...
    public static void onAttachEntityCapabilities(AttachCapabilitiesEvent<Entity> event)
    {
        if (event.getObject() instanceof EntityPlayer)
        {
            ...
            player.getAttributeMap().registerAttribute(AttributesConstants.MAX_MANA);
    ...
    {
        IPlayerMagic playerMagic = event.player.getCapability(CapabilityInit.PLAYER_MAGIC, null);
    ...
    {
        IPlayerThirst oldThirst = event.getOriginal().getCapability(CapabilityInit.PLAYER_THIRST, null);
        IPlayerThirst newThirst = event.getEntityPlayer().getCapability(CapabilityInit.PLAYER_THIRST, null);
        newThirst.cloneCapability(oldThirst, event.isWasDeath());

        IPlayerMagic oldMagic = event.getOriginal().getCapability(CapabilityInit.PLAYER_MAGIC, null);
        IPlayerMagic newMagic = event.getEntityPlayer().getCapability(CapabilityInit.PLAYER_MAGIC, null);
