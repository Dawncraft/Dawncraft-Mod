...
public interface IPlayerMagic extends IEntityMana, ILearning, ICapabilityClonable<IPlayerMagic>
{
    ...
    void sendCancelSpellReason(ITextComponent reason, boolean useActionbar);

    void sendOverlayMessage(ITextComponent textComponent);

    void sendActionBarMessage(ITextComponent textComponent);
}
