...
public class FluidInit
{
    ...
    public static final Fluid PETROLEUM = new Fluid("petroleum", PETROLEUM_STILL, PETROLEUM_FLOWING, PETROLEUM_OVERLAY, 0xFFFFFFFF).setDensity(850).setViscosity(1750);
