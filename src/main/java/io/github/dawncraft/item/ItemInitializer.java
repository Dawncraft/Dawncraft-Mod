...
public class ItemInitializer
{
    ...
    public static void registerItems(RegistryEvent.Register<Item> event)
    {
        ...
        registerItem(new Item().setTranslationKey("magnetIngot").setCreativeTab(CreativeTabs.MATERIALS), "magnet_ingot");
        MAGNET_TOOL.setRepairItem(new ItemStack(magnetIngot));
        ...
        registerItem(new ItemRecord("dj", SoundInitializer.RECORDS_DJ).setTranslationKey("record").setCreativeTab(CreativeTabsLoader.tabColourEgg), "record_dj");
        registerItem(new ItemRecord("wzsongs", SoundInitializer.RECORDS_WZSONGS).setTranslationKey("record").setCreativeTab(CreativeTabsLoader.tabColourEgg), "record_wzsongs");
        
        registerItem(new ItemSword(ItemInitializer.GOLDIAMOND).setTranslationKey("goldiamondSword").setCreativeTab(CreativeTabsLoader.tabColourEgg), "goldiamond_sword");
        registerItem( new ItemHammer(ItemInitializer.MJOLNIR)
        {
            @Override
