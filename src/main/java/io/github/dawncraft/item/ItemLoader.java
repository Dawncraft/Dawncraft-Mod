...
public class ItemLoader
{
    ...
    public static Item faeces = new ItemFood(1, 0.0F, true)
    {
        @Override
    ...
    public static Item throwableTorch = new ItemThrowableTorch().setUnlocalizedName("throwableTorch").setCreativeTab(CreativeTabsLoader.tabWar);
    ...
    public static void initItems()
    {
        ...
        registerItem(throwableTorch, "throwable_torch");
