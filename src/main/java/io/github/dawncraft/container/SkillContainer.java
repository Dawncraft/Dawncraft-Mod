...
public abstract class SkillContainer extends Container
{
    ...
    public void addListener(IContainerListener listener)
    {
        ...
        {
            IPlayerMagic magic = ((EntityPlayer) listener).getCapability(CapabilityInit.PLAYER_MAGIC, null);
    ...
    public void onContainerClosed(EntityPlayer player)
    {
        ...
        SkillInventoryPlayer skillInventoryPlayer = player.getCapability(CapabilityInit.PLAYER_MAGIC, null).getSkillInventory();
