package com.github.wdawning.dawncraft.tileentity.generator;
...
import com.github.wdawning.dawncraft.block.BlockElectricGenerator;

public class TileEntityHeatGenerator extends TileEntity implements IUpdatePlayerListBox, ISidedInventory
{
    ...
    {
        return (IChatComponent) (this.hasCustomName() ? new ChatComponentText(this.getCommandSenderName())
                : new ChatComponentTranslation(this.getCommandSenderName(), new Object[0]));
    }
    ...
    public void update()
    {
            ...
            if (!this.isBurning() && this.canSmelt())
            {
                ...
                if (this.isBurning())
                {
                    ...
                    if (this.eleFurnaceItemStacks[0] != null)
                    {
                        ...
                        {
                            this.eleFurnaceItemStacks[0] = eleFurnaceItemStacks[0].getItem()
                                    .getContainerItem(eleFurnaceItemStacks[0]);
                        }
                    }
                }
            }
        ...
        {
            isBurning = true;
            BlockElectricGenerator.setState(this.isBurning(), this.worldObj, this.pos);
        }
